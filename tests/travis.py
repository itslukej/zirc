...
class Bot(zirc.Client):
    def __init__(self):
        ...
        self.config = IRCConfig(host="irc.stuxnet.xyz", port=6697, nickname="zIRC-CI-"+str(sys.version.split(" ")[0].replace(".", "-").replace("+", "")), ident="ci", realname="zIRC IRCP Library", channels=[])
